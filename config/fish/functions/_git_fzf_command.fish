function _git_fzf_command
    argparse "fzf-flags=" "list-command=" "item-command=" "view-command=" -- $argv
    ...
    set fzf_command "fzf $_flag_fzf_flags --preview=\"$fzf_preview_command\" --bind=\"alt-enter:execute($fzf_view_command)\""
